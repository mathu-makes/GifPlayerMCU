...
public:
  ...
  */
  ...
  bool setGIFtime(uint8_t seconds_per_gif, bool saveToDisk = false);
  uint8_t getGIFtime(void);
  
  bool setRandom(uint8_t y, bool saveToDisk = false);
...
private:
  ...
  uint8_t _volume = 255, _brightness = 255, _seconds_per_gif, _random = 1;
