...
#if defined(ADAFRUIT_ITSYBITSY_M4_EXPRESS) || defined(ARDUINO_NRF52840_CLUE) || defined(ARDUINO_NRF52840_CIRCUITPLAY) || defined(ARDUINO_SAMD_CIRCUITPLAYGROUND_EXPRESS)
